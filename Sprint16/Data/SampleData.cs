...
namespace Sprint16.Data
{
    public class SampleData
    {
        public static void Initialize(ShoppingContext context)
        {
            ...
            {
                new Customer { Fname = "Volodya", Lname = "Myk", Address = "Ivano-Frankivsk", Discount = 0.3 },
                new Customer { Fname = "Hlib", Lname = "Bond", Address = "Dnipro", Discount = 0.5 },
                new Customer { Fname = "Maksym", Lname = "Seer", Address = "Kyiv", Discount = 0.4 }
            };
